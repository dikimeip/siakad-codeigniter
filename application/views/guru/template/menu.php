      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('GuruController/pengumuman') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Pengumuman</span>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('GuruController/edit_user') ?>">
              <i class="ti-pie-chart menu-icon"></i>
              <span class="menu-title">Setting</span>
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('GuruController/logout') ?>">
              <i class="ti-pie-chart menu-icon"></i>
